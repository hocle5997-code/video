...
// Cấu hình đường dẫn FFmpeg static
...
// Hàm theo dõi redirect để phân giải link rút gọn (vt.tiktok.com, vm.tiktok.com)
...
// API phân tích link TikTok
app.post('/api/analyze', async (req, res) => {
    const { url } = req.body;

    if (!url) {
        return res.status(400).json({ success: false, error: 'Vui lòng cung cấp link TikTok!' });
    }
